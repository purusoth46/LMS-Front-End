      ...
      <div className="flex flex-col text-white p-4 md:p-20">
        <div className="flex flex-col md:flex-row items-center gap-10 mx-10">
          <section className="w-full md:w-1/2 scroll-py-10">
            ...
            <p className="text-xl text-black-600 pt-4">
              Our goal is to provide the Affordable and quality education for
              all. We are a team of passionate people whose goal is to improve
        ...
        <div className="carousel w-full md:w-1/2 my-10 mx-auto">
          <div
            id="slide1"
            className="carousel-item relative w-full flex items-center justify-center transition-all duration-300"
          >
            <div className="flex flex-col items-center justify-center gap-4 px-[15%]">
              <img
                src={apj}
                className="w-40 rounded-full border-2 border-blue-400"
              />
              <p className="text-xl text-white text-center">
                {" "}
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio
                officia, eaque rem deleniti non cumque saepe quo repellendus.
              </p>
