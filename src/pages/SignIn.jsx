    ...
    <HomeLayout>
      <div className="flex overflow-x-auto items-center justify-center h-[100vh]">
        <form
          ...
          className="flex flex-col justify-center gap-3 rounded-lg p-4 text-gray-600"
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              autoComplete="email"
              className="p-2 rounded-lg outline-blue bg-transparent border border-blue text-gray-600"
            />
          </div>
          <div className="flex flex-col gap1">
            ...
            <input
              ...
              className="p-2 rounded-lg outline-black bg-transparent border border-blue text-gray-600"
            />
          </div>
          ...
          <p className="text-center">
            ...
            <Link
              to={`/signup`}
              className="text-blue-500 hover:text-blue-300 transition-all ease-in-out duration-300"
            >
              {" "}
              SignUp{" "}
            </Link>
